...
public class  PlantBall extends ItemBase implements Initialisable {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        products.iterator().forEachRemaining(
                item -> {
                    ...
                    Item itemObj = REGISTRY.getObject(resourcelocation);
    ...
    public  List<ItemStack> getTreeVariants() {
...

        {
            ...
            Item sapling = REGISTRY.getObject(new ResourceLocation("minecraft:sapling"));
            Item log = REGISTRY.getObject(new ResourceLocation("minecraft:log"));

            Item log2 = REGISTRY.getObject(new ResourceLocation("minecraft:log2"));
