...
public class CardDissect extends TheorycraftCard {
    ...
    public String getLocalizedName() {
        return (new TextComponentTranslation("card.thaumic_arcana.study_flesh.name", TextFormatting.DARK_BLUE + this.itemStack.getDisplayName() + TextFormatting.RESET + "" + TextFormatting.BOLD)).getFormattedText();
    }

    @Override
    public String getLocalizedText() {

        return (new TextComponentTranslation("card.thaumic_arcana.study_flesh.text", TextFormatting.DARK_BLUE + this.itemStack.getDisplayName() + TextFormatting.RESET)).getFormattedText();
    }
